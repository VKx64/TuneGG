...
export function GameChord() {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Chord Matching Game</Text>
          ...
          {gameState === 'ready' && (
            <View style={styles.gameContainer}>
              <Text style={styles.description}>
                Hit 5 random chords consecutively to win!
              </Text>
          ...
          {gameState === 'playing' && (
            <View style={styles.gameContainer}>
              ...
              <View style={styles.targetNoteContainer}>
                <Text style={styles.targetLabel}>Target Chord:</Text>
              ...
              {isAuthenticated && score === 5 && (
                <>
                  ...
                  <View style={styles.achievementNotice}>
                    ...
                    <Text style={styles.achievementSubDesc}>Win your first round of the Chord Matching game</Text>
                  </View>
                </>
              )}
